...
//            var ch = str.charAt(0);
//            switch (ch) {
//                case 0x02 -> /* ctrl b */ _displayStack.forEach(DisplayPane::cycleBackgroundColor);
//                case 0x03 -> /* ctrl c */ _displayStack.forEach(DisplayPane::cycleTextColor);
//                case 0x08 -> /* ctrl h */ kbBackSpace();
//                case 0x14 -> /* ctrl t */ Kute.getInstance().cycleTabs();
...
//        if ((rows < DisplayPane.MIN_ROWS) || (rows > DisplayPane.MAX_ROWS)) {
//            throw new ParameterException("Display.reconfigure", "rows", rows);
//        }
//        if ((columns < DisplayPane.MIN_COLUMNS) || (columns > DisplayPane.MAX_COLUMNS)) {
//            throw new ParameterException("Display.reconfigure", "columns", columns);
//        }
//
//        _displayStack.forEach(d -> d.reconfigure(rows, columns));
//    }
//
//    // ---------------------------------------------------------------------------------------------
...
//
//        while (_displayStack.size() > 1) {
//            var display = _displayStack.removeFirst();
//            getChildren().remove(display);
//            display.close();
//        }
//        _activeDisplayPane.reset();
//
//        _pendingToHost = null;
//        _sendCursorPosition = false;
//        _sendStatus = true;
...
//        }
//
//        _activeDisplayPane.setCursorPosition(new Coordinates(row, column));
//    }
//
//    private void ingestEscape(final StreamBuffer strm)
//        throws InvalidEscapeSequenceException,
...
//                _keyboardLocked = true;
//                _displayStack.forEach(d -> d.setKeyboardLocked(true));
//            }
//            case 'C' -> _activeDisplayPane.deleteInDisplay();
//            case 'D' -> _activeDisplayPane.insertInDisplay();
//            case 'E' -> {} // transfer changed fields - not implemented
...
//                _keyboardLocked = false;
//                _displayStack.forEach(d -> d.setKeyboardLocked(false));
//            }
//            case 'M' -> _activeDisplayPane.eraseDisplay();
//            case 'T' -> { // Tell the terminal to respond with the cursor position
//                if (!controlPageIsActive()) {
...
//            }
//        } finally {
//            _displayStack.forEach(DisplayPane::drawAll);
//        }
//    }
//
//    // Wrapper around putCharacter(), but we have to get the character from the stream as decimal digits
...
//            } catch (StreamException se) {
//                System.out.printf("Error at byte %d\n", strm.getPosition());
//                _displayStack.forEach(d -> d.setErrorIndicator(true));
//            }
//            return;
//        }
//
...
//        _displayStack.forEach(d -> d.setMessageWaiting(true));
//    }
//
//    public void poll(final boolean includeText) {
...
//        //      for function keys:      SOH code ETX (see 2-2 pg 2-12 for codes)
//        //      for no-traffic:         EOT EOT ETX
//        _displayStack.forEach(d -> d.setPollIndicator(true));
//
//        if (_sendStatus) {
//            _socketHandler.send(new StreamBuffer(STATUS_MESSAGE, 0, STATUS_MESSAGE.length));
//            _sendStatus = false;
...
//    // Pulls up the FCC Generate dialog
//    public void kbFCCGenerate() {
//        if (_keyboardLocked || controlPageIsActive()) {
//            Toolkit.getDefaultToolkit().beep();
//            return;
//        }
//
...
//        }
//
//        sendToPrinter(_activeDisplayPane.getPrintStream(_printMode));
//    }
//
//    /**
//     * If the area under the cursor is not protected, place the character on-screen
...
//
//    public void kbScanDown() {
//        if (_keyboardLocked || !_activeDisplayPane.scanDown()) {
//            Toolkit.getDefaultToolkit().beep();
//        }
//    }
//
//    public void kbScanLeft() {
//        if (_keyboardLocked || !_activeDisplayPane.scanLeft()) {
//            Toolkit.getDefaultToolkit().beep();
//        }
//    }
//
//    public void kbScanRight() {
//        if (_keyboardLocked || !_activeDisplayPane.scanRight()) {
//            Toolkit.getDefaultToolkit().beep();
//        }
//    }
//
//    public void kbScanUp() {
//        if (_keyboardLocked || !_activeDisplayPane.scanUp()) {
//            Toolkit.getDefaultToolkit().beep();
//        }
//    }
//
...
//    private void toggleControlPage() {
//        if (controlPageIsActive()) {
//            var cp = _displayStack.removeFirst();
//            cp.close();
//            getChildren().remove(cp);
//            _activeDisplayPane.drawAll();
//        } else {
//            var display = _activeDisplayPane;
//            var controlPanel = new ControlPageDisplayPane(display.getColumns(),
//                                                          display.getTextColor(),
//                                                          display.getBackgroundColor());
//            getChildren().addLast(controlPanel);
//            _displayStack.addFirst(controlPanel);
//        }
//    }
//}
