...
public class UnresolvedReferenceToLiteral extends UnresolvedReference {
    ...
    public UnresolvedReference copy(
        ...
        return new UnresolvedReferenceToLiteral(_fieldDescriptor, isNegative, _locationCounterIndex);
    }
    ...
    public UnresolvedReference copy(
        ...
        return new UnresolvedReferenceToLiteral(fieldDescriptor, _isNegative, _locationCounterIndex);
    }
