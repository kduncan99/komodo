...
public class Linker {
    ...
    public static class LCPoolSpecification {
        final OldRelocatableModule _module;
        final int _lcIndex;

        public LCPoolSpecification(
            final OldRelocatableModule module,
            final int lcIndex
        ) {
            _module = module;
            _lcIndex = lcIndex;
    ...
    private class EntryPointInfo {
        ...
        private OldRelocatableModule _entryPointRelocatableModule = null;  //  Module containing the entry point
        ...
        private EntryPointInfo(
            ...
            for (OldRelocatableModule module : _moduleSet._set) {
    ...
    private static class LinkerValue extends IntegerValue {
        ...
        private final OldRelocatableModule _relocatableModule;

        private LinkerValue(
            final long value,
            final UndefinedReference[] undefinedReferences,
            final Integer lcIndex,
            final OldRelocatableModule relocatableModule
        ) {
    ...
    private static class Modes {
        ...
        private Modes(
            ...
            for (OldRelocatableModule module : moduleSet._set) {
    ...
    private static class ModuleSet {
        private final Set<OldRelocatableModule> _set = new HashSet<>();
    ...
    private Modes determineModes(
        final OldRelocatableModule entryPointRelModule
    ) {
