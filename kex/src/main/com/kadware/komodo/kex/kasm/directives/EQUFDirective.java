...
public class EQUFDirective extends Directive {
    ...
    private IntegerValue integrate(
        ...
        return null;//TODO leverage IntegerValue.integate()
...
//        }
//
//        return new IntegerValue(locale, new DoubleWord36(finalInt), null, finalRefs);
    }
    ...
    public void process(
        ...
        //TODO rework this in light of new EQUF refactoring
