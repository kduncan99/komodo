...
public class BootStrap {
    ...
    public static final String[] SOURCE = {
        ...
        ".   Obtain two suitably-sized blocks of memory from the MSP:",
        ".     Block 1 is populated as the partition databank",
        ".     Block 2 is loaded with bootstrap code - i.e., this bit of code",
        ".       which is always the first block on the boot media",
        ".   Set the following registers in the IP:",
        ".     B0 to refer to the bootstrap block",
        ".     B2 to refer to the configuration bank",
        ...
        "          LA,S4     A0,0,B2             . MSP UPI again, zero offset",
        "          LSSL      A0,32",
        ...
        "          LA,S3     A0,0,,B2            . UPI of load IOP",
        "          SA,S2     A0,IOPKT,,B0",
        "          LA,S5     A0,0,,B2            . Channel Module Index",
        "          SA,S3     A0,IOPKT,,B0",
        "          LA,S6     A0,0,,B2            . Device Index",
        "          SA,S4     A0,IOPKT,,B0",
        "",
