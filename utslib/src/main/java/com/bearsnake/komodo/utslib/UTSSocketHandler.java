...
import com.bearsnake.komodo.utslib.messages.DisconnectMessage;
import com.bearsnake.komodo.utslib.messages.StatusMessage;
...
public class UTSSocketHandler extends SocketHandler implements SocketListener {
    ...
    public void write(final UTSMessage message) throws IOException {
        super.write(message.getByteBuffer().position(0));
    }
}
