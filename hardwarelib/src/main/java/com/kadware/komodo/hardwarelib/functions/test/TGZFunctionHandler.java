 ...
 */
public class TGZFunctionHandler extends InstructionHandler {
    ...
    public void handle(
        ...
        if (OnesComplement.isPositive36(op) && !OnesComplement.isPositiveZero36(op)) {
            ip.setProgramCounter(ip.getProgramAddressRegister().getProgramCounter() + 1, false);
        }
    }

    @Override
    public Instruction getInstruction() { return Instruction.TGZ; }
}
