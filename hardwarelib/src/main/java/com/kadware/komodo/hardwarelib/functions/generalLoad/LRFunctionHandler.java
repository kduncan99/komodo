 ...
 */
public class LRFunctionHandler extends InstructionHandler {
    ...
    public void handle(
        ...
        ip.setExecOrUserRRegister((int) iw.getA(), operand);
    }

    @Override
    public Instruction getInstruction() { return Instruction.LR; }
}
