 ...
 */
public class LDSLFunctionHandler extends InstructionHandler {
    ...
    public synchronized void handle(
        ...
        OnesComplement.leftShiftLogical72(_operand, count, _result);
    ...
    @Override
    public Instruction getInstruction() { return Instruction.LDSL; }
}
