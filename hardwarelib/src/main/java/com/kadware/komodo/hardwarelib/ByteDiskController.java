...
/**
 * Models a disk controller with a byte interface
 */
public class ByteDiskController extends Controller {
    ...
    private static final Logger LOGGER = LogManager.getLogger(ByteDiskController.class);
    ...
    public ByteDiskController(
        final String name,
        final short subsystemIdentifier
    ) {
        super(Controller.ControllerType.ByteDisk, name, subsystemIdentifier);
    }
