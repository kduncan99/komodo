 ...
 */
public class ANHFunctionHandler extends FunctionHandler {
    ...
    public void handle(
        ...
        long op2h1 = OnesComplement.negate18(Word36.getH1(operand2));
        long op2h2 = OnesComplement.negate18(Word36.getH2(operand2));
