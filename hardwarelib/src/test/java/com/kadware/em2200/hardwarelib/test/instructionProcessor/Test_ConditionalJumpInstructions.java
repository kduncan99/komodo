...
public class Test_ConditionalJumpInstructions extends BaseFunctions {
    ...
    public void jumpModifierGreaterAndIncrement_extended(
        ...
        assertEquals(0_000002_000004L, processors._instructionProcessor.getGeneralRegister(GeneralRegisterSet.X0).getW());
        assertEquals(0_000002_000002L, processors._instructionProcessor.getGeneralRegister(GeneralRegisterSet.X1).getW());
        assertEquals(0_000001_001015L, processors._instructionProcessor.getGeneralRegister(GeneralRegisterSet.X2).getW());
        assertEquals(0_777776_000007L, processors._instructionProcessor.getGeneralRegister(GeneralRegisterSet.X3).getW());
        assertEquals(0_000002_001023L, processors._instructionProcessor.getGeneralRegister(GeneralRegisterSet.X4).getW());
    }
