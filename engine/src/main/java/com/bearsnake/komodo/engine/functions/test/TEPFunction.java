...
/**
 * Test Even Parity instruction
 * (TEP) Checks the parity of A(a) AND U, and jumps if the parity is even.
 * If the test succeeds, skip the next instruction by incrementing the program counter.
 */
public class TEPFunction extends Function {

    public static final TEPFunction INSTANCE = new TEPFunction();

    private TEPFunction() {
        super("TEP");
        var fc = new FunctionCode(0_44);
