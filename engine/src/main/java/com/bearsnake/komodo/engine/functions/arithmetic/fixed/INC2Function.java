...
/**
 * Increment Storage by 2 instruction
 * (INC2) Increments the operand by 2 under storage lock.
 ...
 */
public class INC2Function extends FixedFunction {

    public static final INC2Function INSTANCE = new INC2Function();

    private INC2Function() {
        super("INC2");
        setBasicModeFunctionCode(new FunctionCode(0_05).setAField(0_012));
        setExtendedModeFunctionCode(new FunctionCode(0_05).setAField(0_012));
    ...
    public boolean execute(
        ...
        increment(engine, operand, 2, true);
