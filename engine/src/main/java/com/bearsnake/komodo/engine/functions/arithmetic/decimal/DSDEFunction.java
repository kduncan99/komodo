 ...
 */
public class DSDEFunction extends DecimalFunction {

    public static final DSDEFunction INSTANCE = new DSDEFunction();

    private DSDEFunction() {
        super("DSDE");
        var fc = new FunctionCode(0_07).setJField(0_03);
