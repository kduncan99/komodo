...
/**
 * Add One to Storage instruction
 * (ADD1) Increments the operand by 1 under storage lock.
 ...
 */
public class ADD1Function extends FixedFunction {

    public static final ADD1Function INSTANCE = new ADD1Function();

    private ADD1Function() {
        super("ADD1");
        setBasicModeFunctionCode(new FunctionCode(0_05).setAField(0_015).setProcessorPrivilege(0));
        setExtendedModeFunctionCode(new FunctionCode(0_05).setAField(0_015));
