...
/**
 * Increment Storage instruction
 * (INC) Increments the operand by 1 under storage lock.
 ...
 */
public class INCFunction extends FixedFunction {

    public static final INCFunction INSTANCE = new INCFunction();

    private INCFunction() {
        super("INC");
        setBasicModeFunctionCode(new FunctionCode(0_05).setAField(0_010));
        setExtendedModeFunctionCode(new FunctionCode(0_05).setAField(0_010));
    ...
    public boolean execute(
        ...
        increment(engine, operand, 1, true);
