 ...
 * (TNE) Checks the value of U to see if it is not equal to A(a).
 * If the test succeeds, skip the next instruction by incrementing the program counter.
 */
public class TNEFunction extends Function {

    public static final TNEFunction INSTANCE = new TNEFunction();

    private TNEFunction() {
        super("TNE");
        var fc = new FunctionCode(053);
