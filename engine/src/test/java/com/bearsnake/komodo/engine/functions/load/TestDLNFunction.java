...
public class TestDLNFunction extends TestFunction {
    ...
    public void testDLN_BM() throws MachineInterrupt {
        ...
        assertEquals(0_777776_777776L, _engine.getGeneralRegisterSet().getRegister(_engine.getExecOrUserARegisterIndex(0)).getW());
        assertEquals(0_377775_777775L, _engine.getGeneralRegisterSet().getRegister(_engine.getExecOrUserARegisterIndex(1)).getW());
    ...
    public void testDLN_EM() throws MachineInterrupt {
        ...
        assertEquals(0_777774_777774L, _engine.getGeneralRegisterSet().getRegister(_engine.getExecOrUserARegisterIndex(12)).getW());
        assertEquals(0_777773_777773L, _engine.getGeneralRegisterSet().getRegister(_engine.getExecOrUserARegisterIndex(13)).getW());
    }
    ...
    public void testDLN_Indirect_BM() throws MachineInterrupt {
        ...
        assertEquals(0_777776_777776L, _engine.getGeneralRegisterSet().getRegister(_engine.getExecOrUserARegisterIndex(0)).getW());
        assertEquals(0_777775_777775L, _engine.getGeneralRegisterSet().getRegister(_engine.getExecOrUserARegisterIndex(1)).getW());
        assertEquals(0_377774_777774L, _engine.getGeneralRegisterSet().getRegister(_engine.getExecOrUserARegisterIndex(2)).getW());
        assertEquals(0_777773_777773L, _engine.getGeneralRegisterSet().getRegister(_engine.getExecOrUserARegisterIndex(3)).getW());
