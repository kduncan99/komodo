...
public class TestTNMZFunction extends FunctionUnitTest {
    ...
    private long tnmzEM(long j, long x, long h, long i, long b, long d) {
        // Extended mode TNMZ has A field = 013
        return fjaxhibd(050, j, 013, x, h, i, b, d);
    }

    @Test
    public void testTNMZ_NegativeZero_EM() throws MachineInterrupt {
        var code = new long[] {
            tnmzEM(Constants.JFIELD_W, 0, 0, 0, 2, 0),
            0,
            0,
        };
    ...
    @Test
    public void testTNMZ_PositiveZero_EM() throws MachineInterrupt {
        var code = new long[] {
            tnmzEM(Constants.JFIELD_W, 0, 0, 0, 2, 0),
            0,
            0,
    ...
    @Test
    public void testTNMZ_NonZero_EM() throws MachineInterrupt {
        var code = new long[] {
            tnmzEM(Constants.JFIELD_W, 0, 0, 0, 2, 0),
            0,
            0,
