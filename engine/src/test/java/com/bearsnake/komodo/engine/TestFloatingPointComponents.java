...
public class TestFloatingPointComponents {
    ...
    public void checkExponent_under() {
        Exception _ = assertThrows(CharacteristicUnderflowException.class, () -> {
    ...
    public void checkExponent_over() {
        Exception _ = assertThrows(CharacteristicOverflowException.class, () -> {
    ...
    public void divide_byZero() {
        Exception _ = assertThrows(DivideByZeroException.class, () -> {
            ...
            FloatingPointComponents _ = operand1.divide(operand2);
        });
    }
    ...
    public void normalize_Underflow() {
        Exception e = assertThrows(CharacteristicUnderflowException.class, () -> {
            ...
            FloatingPointComponents _ = operand.normalize();
        });
    }
