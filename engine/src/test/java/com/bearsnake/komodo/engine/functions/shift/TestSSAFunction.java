...
public class TestSSAFunction extends FunctionUnitTest {
    ...
    @Test
    public void testSSA_Positive_1_EM() throws MachineInterrupt {
        var code = new long[] {
            ssaImm(0, 0, 1),
            0,
        };
    ...
    @Test
    public void testSSA_Negative_1_EM() throws MachineInterrupt {
        var code = new long[] {
            ssaImm(1, 0, 1),
            0,
        };
    ...
    @Test
    public void testSSA_ShiftAll_EM() throws MachineInterrupt {
        var code = new long[] {
            ssaImm(5, 0, 36),
            0,
        };
