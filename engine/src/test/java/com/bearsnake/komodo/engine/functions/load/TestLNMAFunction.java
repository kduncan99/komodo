...
public class TestLNMAFunction extends TestFunction {
    ...
    private long lnmaBM(long j, long a, long x, long h, long i, long u) {
        return fjaxhiu(013, j, a, x, h, i, u);
    }

    private long lnmaEM(long j, long a, long x, long h, long i, long b, long d) {
        return fjaxhibd(013, j, a, x, h, i, b, d);
    }
    ...
    @Test
    public void testLNMAImmediate_EM() throws MachineInterrupt {
        var code = new long[] {
            lnmaImm(Constants.JFIELD_U, 0, 0, 0123),
            lnmaImm(Constants.JFIELD_U, 1, 0, 0777773),
            lnmaImm(Constants.JFIELD_XU, 2, 0, 0777773),
            0,
        };
        ...
        assertEquals(0_777777_000004L, _engine.getGeneralRegisterSet().getRegister(_engine.getExecOrUserARegisterIndex(1)).getW());
        assertEquals(0_777777_777773L, _engine.getGeneralRegisterSet().getRegister(_engine.getExecOrUserARegisterIndex(2)).getW());
    }

    @Test
    public void testLNMA_EM() throws MachineInterrupt {
        var code = new long[] {
            lnmaEM(Constants.JFIELD_W, 12, 0, 0, 0, 1, 02),
            lnmaEM(Constants.JFIELD_W, 13, 0, 0, 0, 1, 03),
            0,
        };
        ...
        assertEquals(0_777777_777774L, _engine.getGeneralRegisterSet().getRegister(_engine.getExecOrUserARegisterIndex(12)).getW());
        assertEquals(0_777777_777773L, _engine.getGeneralRegisterSet().getRegister(_engine.getExecOrUserARegisterIndex(13)).getW());
    }

    @Test
    public void testLA_Indexed_EM() throws MachineInterrupt {
        var code = new long[] {
            lnmaEM(Constants.JFIELD_W, 5, 3, 1, 0, 1, 01),
            0,
            };
    ...
    @Test
    public void testLNMA_Tx_BM() throws MachineInterrupt {
        var code = new long[]{
            lnmaBM(Constants.JFIELD_T1, 0, 0, 0, 0, 040000),
            lnmaBM(Constants.JFIELD_T2, 1, 0, 0, 0, 040001),
            lnmaBM(Constants.JFIELD_T3, 2, 0, 0, 0, 040002),
            0,
            };
    ...
    @Test
    public void testLNMA_Qx_EM() throws MachineInterrupt {
        var code = new long[] {
            lnmaEM(Constants.JFIELD_Q1, 12, 0, 0, 0, 1, 0),
            lnmaEM(Constants.JFIELD_Q2, 13, 0, 0, 0, 1, 0),
            lnmaEM(Constants.JFIELD_Q3, 14, 0, 0, 0, 1, 0),
            lnmaEM(Constants.JFIELD_Q4, 15, 0, 0, 0, 1, 0),
            0,
        };
