...
public class TestJPFunction extends TestFunction {
    ...
    @Test
    public void testJP_BM() throws MachineInterrupt, EngineHaltedException {
        setupBM();
    ...
    @Test
    public void testJP_EM() throws MachineInterrupt, EngineHaltedException {
        setupEM();
    ...
    @Test
    public void testJP_GRS_X() throws MachineInterrupt, EngineHaltedException {
        setupBM();
        var bank = _engine.getBaseRegister(12).getStorage();
    ...
    @Test
    public void testJP_GRS_A() throws MachineInterrupt, EngineHaltedException {
        setupBM();
        var bank = _engine.getBaseRegister(12).getStorage();
