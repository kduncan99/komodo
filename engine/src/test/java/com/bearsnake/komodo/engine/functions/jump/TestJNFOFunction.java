...
public class TestJNFOFunction extends FunctionUnitTest {
    ...
    @Test
    public void testJNFO_BM() throws MachineInterrupt {
        var code = new long[01000];
        code[0] = jnfoBM(0_1005);
    ...
    @Test
    public void testJNFO_BM_NoJump() throws MachineInterrupt {
        var code = new long[01000];
        code[0] = jnfoBM(0_1005);
    ...
    @Test
    public void testJNFO_EM() throws MachineInterrupt {
        var code = new long[01000];
        code[0] = jnfoEM(0_1005);
    ...
    @Test
    public void testJNFO_EM_NoJump() throws MachineInterrupt {
        var code = new long[01000];
        code[0] = jnfoEM(0_1005);
    ...
    @Test
    public void testJNFO_Indexed_BM() throws MachineInterrupt {
        var code = new long[01000];
        code[0] = jnfoBM(3, 0, 0, 0_1005); // jump to 0_1005 + X3.m (0_10) = 0_1015
    ...
    @Test
    public void testJNFO_Indirect_BM() throws MachineInterrupt {
        var code = new long[03000];
        code[0] = jnfoBM(0, 0, 1, 0_2000); // jump indirect via 0_1000
    ...
    @Test
    public void testJNFO_Indexed_EM() throws MachineInterrupt {
        var code = new long[01000];
        code[0] = jnfoEM(3, 0_1100); // jump to 0_1100 + X3.m (0_10) = 0_1100
