...
public class TestJNFOFunction extends FunctionUnitTest {

    private long jnfoBM(long x, long h, long i, long u) {
        return fjaxhiu(0_74, 0_15, 0_02, x, h, i, u);
    }

    private long jnfoBM(long u) {
        return jnfoBM(0, 0, 0, u);
    }

    private long jnfoEM(long x, long u) {
        return fjaxu(0_74, 0_15, 0_02, x, u);
    }

    private long jnfoEM(long u) {
        return jnfoEM(0, u);
    }
    ...
    @Test
    public void testJNFO_BM() throws MachineInterrupt, EngineHaltedException {
        setupBM();
        var bank = _engine.getBaseRegister(12).getStorage();
        bank.set(0, jnfoBM(0_100));

        // Case 1: Characteristic Overflow set -> Should NOT jump
        ...
        // Case 2: Characteristic Overflow clear -> Should jump
    ...
    @Test
    public void testJNFO_EM() throws MachineInterrupt, EngineHaltedException {
        setupEM();
        var bank = _engine.getBaseRegister(0).getStorage();
        bank.set(0, jnfoEM(0_100));
    ...
    @Test
    public void testJNFO_Indexed_BM() throws MachineInterrupt, EngineHaltedException {
        setupBM();
        _engine.getExecOrUserXRegister(3).setXM(0_10);
        var bank = _engine.getBaseRegister(12).getStorage();
        bank.set(0, jnfoBM(3, 0, 0, 0_100)); // jump to 0_100 + X3.m (0_10) = 0_110
    ...
    @Test
    public void testJNFO_Indirect_BM() throws MachineInterrupt, EngineHaltedException {
        setupBM();
        var bank = _engine.getBaseRegister(12).getStorage();
        bank.set(0, jnfoBM(0, 0, 1, 0_100)); // jump indirect via 0_100
    ...
    @Test
    public void testJNFO_Indexed_EM() throws MachineInterrupt, EngineHaltedException {
        setupEM();
        _engine.getExecOrUserXRegister(3).setXM(0_10);
        var bank = _engine.getBaseRegister(0).getStorage();
        bank.set(0, jnfoEM(3, 0_100)); // jump to 0_100 + X3.m (0_10) = 0_110
