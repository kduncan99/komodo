...
public class TestJNCFunction extends TestFunction {
    ...
    @Test
    public void testJNC_BM() throws MachineInterrupt, EngineHaltedException {
        setupBM();
        var bank = _engine.getBaseRegister(12).getStorage();
        bank.set(0, jncBM(0_100));

        // Case 1: Carry set -> Should NOT jump
        ...
        // Case 2: Carry clear -> Should jump
    ...
    @Test
    public void testJNC_EM() throws MachineInterrupt, EngineHaltedException {
        setupEM();
        var bank = _engine.getBaseRegister(0).getStorage();
        bank.set(0, jncEM(0_100));
    ...
    @Test
    public void testJNC_Indirect_BM() throws MachineInterrupt, EngineHaltedException {
        setupBM();
        var bank = _engine.getBaseRegister(12).getStorage();
        bank.set(0, jncBM(0, 0, 1, 0_100)); // jump indirect via 0_100
