 ...
 * f=075, j=015.
 */
public class TestCRFunction extends FunctionUnitTest {
    ...
    public void testCR_Success_BM() throws MachineInterrupt {
        ...
        loadBaseRegister((short) 14, false, 0_22000, 0_25777, AbsoluteAddress.encodeToLong(1, 0), data);
    ...
    public void testCR_InvalidInstruction_BM_Privilege1() {
        ...
        loadBaseRegister((short) 12, false, 0, 0_777777, AbsoluteAddress.encodeToLong(0, 0), code);
