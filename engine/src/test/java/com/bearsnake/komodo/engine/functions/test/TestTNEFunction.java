 ...
 * (TNE) skips if (U) != A(a).
 * f=053 for both modes.
 */
public class TestTNEFunction extends FunctionUnitTest {
    ...
    private long tneImm(long j, long a, long x, long u) {
        return fjaxu(0_53, j, a, x, u);
    }

    private long tneBM(long j, long a, long x, long h, long i, long u) {
        return fjaxhiu(0_53, j, a, x, h, i, u);
    }

    private long tneEM(long j, long a, long x, long h, long i, long b, long d) {
        return fjaxhibd(0_53, j, a, x, h, i, b, d);
    }

    @Test
    public void testTNE_Immediate_BM() throws MachineInterrupt {
        var code = new long[] {
            tneImm(Constants.JFIELD_XU, 2, 0, 0404040),
            0,
            tneImm(Constants.JFIELD_U, 2, 0, 0404040),
            0,
            0,
            };
    ...
    @Test
    public void testTNE_Immediate_EM() throws MachineInterrupt {
        var code = new long[] {
            tneImm(Constants.JFIELD_XU, 2, 0, 0404040),
            0,
            tneImm(Constants.JFIELD_U, 2, 0, 0404040),
    ...
    @Test
    public void testTNE_W_EM() throws MachineInterrupt {
        var code = new long[] {
            tneEM(Constants.JFIELD_W, 2, 3, 0, 0, 2, 0),
            0,
            tneEM(Constants.JFIELD_W, 2, 3, 0, 0, 2, 01),
            0,
            0,
            };
    ...
    @Test
    public void testTNE_ReferenceViolation_EM() throws MachineInterrupt {
        var code = new long[] {
            tneEM(Constants.JFIELD_W, 2, 3, 0, 0, 2, 0),
            0,
            tneEM(Constants.JFIELD_W, 2, 3, 0, 0, 2, 01),
    ...
    @Test
    public void testTNE_GRS_EM() throws MachineInterrupt {
        var code = new long[] {
            tneEM(Constants.JFIELD_W, 2, 0, 0, 0, 0, GRS_A5),
            0,
            0,
            };
        ...
        _engine.getExecOrUserARegister(2).setW(0_000003_000103L);
    ...
    @Test
    public void testTNE_GRS_ReferenceViolation_EM() throws MachineInterrupt {
        var code = new long[] {
            tneEM(Constants.JFIELD_W, 2, 0, 0, 0, 0, 040),
            0,
            0,
            };
    ...
    @Test
    public void testTNE_Q3_EM() throws MachineInterrupt {
        var code = new long[] {
            tneEM(Constants.JFIELD_Q3, 2, 0, 0, 0, 2, 0),
            0,
            0,
            };
        ...
        _engine.getExecOrUserARegister(2).setW(0_555L);
    ...
    @Test
    public void testTNEIndirect_BM() throws MachineInterrupt {
        var code = new long[] {
            tneBM(Constants.JFIELD_W, 2, 0, 0, 1, 022004),
            0,
            0,
