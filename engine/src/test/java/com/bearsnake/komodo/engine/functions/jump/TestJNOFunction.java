...
public class TestJNOFunction extends FunctionUnitTest {
    ...
    @Test
    public void testJNO_BM() throws MachineInterrupt {
    ...
    @Test
    public void testJNO_BM_NoJump() throws MachineInterrupt {
        var code = new long[01000];
        code[0] = jnoBM(0_1005);
    ...
    @Test
    public void testJNO_EM() throws MachineInterrupt {
        var code = new long[01000];
        code[0] = jnoEM(0_1005);
    ...
    @Test
    public void testJNO_EM_NoJump() throws MachineInterrupt {
        var code = new long[01000];
        code[0] = jnoEM(0_1005);
    ...
    @Test
    public void testJNO_Indexed_BM() throws MachineInterrupt {
        var code = new long[01000];
    ...
    @Test
    public void testJNO_Indirect_BM() throws MachineInterrupt {
        var code = new long[03000];
        code[0] = jnoBM(0, 0, 1, 0_2000); // jump indirect via 0_1000
    ...
    @Test
    public void testJNO_Indexed_EM() throws MachineInterrupt {
        var code = new long[01000];
