...
public class TestJNOFunction extends FunctionUnitTest {
    ...
    private long jnoBM(long u) {
        return jnoBM(0, 0, 0, u);
    }

    private long jnoEM(long x, long u) {
        return fjaxu(0_74, 0_15, 0, x, u);
    }

    private long jnoEM(long u) {
        return jnoEM(0, u);
    }
    ...
    @Test
    public void testJNO_BM() throws MachineInterrupt, EngineHaltedException {
        setupBM();
        var bank = _engine.getBaseRegister(12).getStorage();
        bank.set(0, jnoBM(0_100));

        // Case 1: Overflow set -> Should NOT jump
        ...
        // Case 2: Overflow clear -> Should jump
    ...
    @Test
    public void testJNO_EM() throws MachineInterrupt, EngineHaltedException {
        setupEM();
        var bank = _engine.getBaseRegister(0).getStorage();
        bank.set(0, jnoEM(0_100));
    ...
    @Test
    public void testJNO_Indexed_BM() throws MachineInterrupt, EngineHaltedException {
        setupBM();
        _engine.getExecOrUserXRegister(3).setXM(0_10);
        var bank = _engine.getBaseRegister(12).getStorage();
        bank.set(0, jnoBM(3, 0, 0, 0_100)); // jump to 0_100 + X3.m (0_10) = 0_110
    ...
    @Test
    public void testJNO_Indirect_BM() throws MachineInterrupt, EngineHaltedException {
        setupBM();
        var bank = _engine.getBaseRegister(12).getStorage();
        bank.set(0, jnoBM(0, 0, 1, 0_100)); // jump indirect via 0_100
    ...
    @Test
    public void testJNO_Indexed_EM() throws MachineInterrupt, EngineHaltedException {
        setupEM();
        _engine.getExecOrUserXRegister(3).setXM(0_10);
        var bank = _engine.getBaseRegister(0).getStorage();
        bank.set(0, jnoEM(3, 0_100)); // jump to 0_100 + X3.m (0_10) = 0_110
