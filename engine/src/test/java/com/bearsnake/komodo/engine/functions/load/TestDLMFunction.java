...
public class TestDLMFunction extends FunctionUnitTest {

    private long dlmBM(long a, long x, long h, long i, long u) {
        return fjaxhiu(071, 015, a, x, h, i, u);
    }

    private long dlmEM(long a, long x, long h, long i, long b, long d) {
        return fjaxhibd(071, 015, a, x, h, i, b, d);
    }
    ...
    @Test
    public void testDLM_BM() throws MachineInterrupt {
        var code = new long[] {
            dlmBM(0, 0, 0, 0, 030000),
            dlmBM(2, 2, 0, 0, 030000),
            0,
            };
    ...
    @Test
    public void testDLM_EM() throws MachineInterrupt {
        var code = new long[] {
            dlmEM(10, 0, 0, 0, 5, 01000),
            dlmEM(12, 2, 0, 0, 5, 01000),
            0
        };
        ...
        loadBaseRegister((short) 0, false, 0_1000, 0_001777, 0, code);
        loadBaseRegister((short) 5, false, 0_1000, 0_001777, 0, data);
    ...
    @Test
    public void testDLM_Indirect_BM() throws MachineInterrupt {
        var code = new long[] {
            dlmBM(0, 0, 0, 0, 030000),
            dlmBM(2, 2, 0, 0, 030000),
            dlmBM(4, 3, 0, 1, 030000), // indirect to data,X3
            0
        };
