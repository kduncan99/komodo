...
public class TestJNBFunction extends FunctionUnitTest {
    ...
    @Test
    public void testJNB_BM() throws MachineInterrupt {
        var code = new long[01000];
        code[0] = jnbBM(5, 0_1005);   // JNB  A5,01005
    ...
    @Test
    public void testJNB_BM_NoJump() throws MachineInterrupt {
        var code = new long[01000];
        code[0] = jnbBM(5, 0_1005);   // JNB  A5,01005
    ...
    @Test
    public void testJNB_EM() throws MachineInterrupt {
        var code = new long[01000];
        code[0] = jnbEM(5, 0_1005);   // JNB  A5,01005
    ...
    @Test
    public void testJNB_EM_NoJump() throws MachineInterrupt {
        var code = new long[01000];
        code[0] = jnbEM(5, 0_1005);   // JNB  A5,01005
    ...
    @Test
    public void testJNB_Indexed_BM() throws MachineInterrupt {
        var code = new long[01000];
        code[0] = jnbBM(5, 3, 0, 0, 0_1005); // jump to 0_1005 + X3.m (0_10) = 0_1015
    ...
    @Test
    public void testJNB_Indirect_BM() throws MachineInterrupt {
        var code = new long[03000];
        code[0] = jnbBM(5, 0, 0, 1, 0_2000); // jump indirect via 0_1000
    ...
    @Test
    public void testJNB_Indexed_EM() throws MachineInterrupt {
        var code = new long[01000];
        code[0] = jnbEM(5, 3, 0_1100); // jump to 0_1100 + X3.m (0_10) = 0_1100
