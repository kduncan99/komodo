...
public class TestJNBFunction extends FunctionUnitTest {

    private long jnbBM(long a, long x, long h, long i, long u) {
        return fjaxhiu(0_74, 0_10, a, x, h, i, u);
    }

    private long jnbBM(long a, long u) {
        return jnbBM(a, 0, 0, 0, u);
    }

    private long jnbEM(long a, long x, long u) {
        return fjaxu(0_74, 0_10, a, x, u);
    }

    private long jnbEM(long a, long u) {
        return jnbEM(a, 0, u);
    }
    ...
    @Test
    public void testJNB_BM() throws MachineInterrupt, EngineHaltedException {
        setupBM();
        var bank = _engine.getBaseRegister(12).getStorage();
        bank.set(0, jnbBM(5, 0_100)); // JNB if A5 low bit is clear, jump to 0_100

        // Case 1: A5 bit 0 is clear -> Should jump
        ...
        // Case 2: A5 bit 0 is set -> Should NOT jump
    ...
    @Test
    public void testJNB_EM() throws MachineInterrupt, EngineHaltedException {
        setupEM();
        var bank = _engine.getBaseRegister(0).getStorage();
        bank.set(0, jnbEM(5, 0_100)); // JNB if A5 low bit is clear, jump to 0_100
    ...
    @Test
    public void testJNB_Indexed_BM() throws MachineInterrupt, EngineHaltedException {
        setupBM();
        _engine.getExecOrUserXRegister(3).setXM(0_10);
        _engine.getExecOrUserARegister(5).setW(02);
        var bank = _engine.getBaseRegister(12).getStorage();
        bank.set(0, jnbBM(5, 3, 0, 0, 0_100)); // jump to 0_100 + X3.m (0_10) = 0_110
    ...
    @Test
    public void testJNB_Indirect_BM() throws MachineInterrupt, EngineHaltedException {
        setupBM();
        _engine.getExecOrUserARegister(5).setW(02);
        var bank = _engine.getBaseRegister(12).getStorage();
        bank.set(0, jnbBM(5, 0, 0, 1, 0_100)); // jump indirect via 0_100
    ...
    @Test
    public void testJNB_Indexed_EM() throws MachineInterrupt, EngineHaltedException {
        setupEM();
        _engine.getExecOrUserXRegister(3).setXM(0_10);
        _engine.getExecOrUserARegister(5).setW(02);
        var bank = _engine.getBaseRegister(0).getStorage();
        bank.set(0, jnbEM(5, 3, 0_100)); // jump to 0_100 + X3.m (0_10) = 0_110
