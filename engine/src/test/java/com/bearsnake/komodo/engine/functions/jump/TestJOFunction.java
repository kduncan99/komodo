...
public class TestJOFunction extends TestFunction {
    ...
    @Test
    public void testJO_BM() throws MachineInterrupt, EngineHaltedException {
        setupBM();
        var bank = _engine.getBaseRegister(12).getStorage();
        bank.set(0, joBM(0_100));

        // Case 1: Overflow set -> Should jump
        ...
        // Case 2: Overflow clear -> Should NOT jump
    ...
    @Test
    public void testJO_EM() throws MachineInterrupt, EngineHaltedException {
        setupEM();
        var bank = _engine.getBaseRegister(0).getStorage();
        bank.set(0, joEM(0_100));
    ...
    @Test
    public void testJO_Indexed_BM() throws MachineInterrupt, EngineHaltedException {
        setupBM();
        _engine.getExecOrUserXRegister(3).setXM(0_10);
        var bank = _engine.getBaseRegister(12).getStorage();
        bank.set(0, joBM(3, 0, 0, 0_100)); // jump to 0_100 + X3.m (0_10) = 0_110
    ...
    @Test
    public void testJO_Indirect_BM() throws MachineInterrupt, EngineHaltedException {
        setupBM();
        var bank = _engine.getBaseRegister(12).getStorage();
        bank.set(0, joBM(0, 0, 1, 0_100)); // jump indirect via 0_100
    ...
    @Test
    public void testJO_Indexed_EM() throws MachineInterrupt, EngineHaltedException {
        setupEM();
        _engine.getExecOrUserXRegister(3).setXM(0_10);
        var bank = _engine.getBaseRegister(0).getStorage();
        bank.set(0, joEM(3, 0_100)); // jump to 0_100 + X3.m (0_10) = 0_110
