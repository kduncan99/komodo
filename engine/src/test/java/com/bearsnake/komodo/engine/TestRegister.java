...
public class TestRegister {
    ...
    public void testGetValue() {
        ...
        reg.setValue(0_123456_765432L);
        assertEquals(0_123456_765432L, reg.getValue());
    }
    ...
    public void testSetValue() {
        ...
        reg.setValue(0_123456_765432L);
        assertEquals(0_123456_765432L, reg.getValue());
        reg.setValue(0_777777_000000L);
        assertEquals(0_777777_000000L, reg.getValue());
    }
    ...
    public void testSetXI() {
        ...
        reg.setValue(0);
        reg.setXI(0_123456L);
        assertEquals(0_123456_000000L, reg.getValue());
    }
    ...
    public void testSetXI12() {
        ...
        reg.setValue(0);
        reg.setXI12(0_1234L);
        assertEquals(0_123400_000000L, reg.getValue());
    }
    ...
    public void testSetXM() {
        ...
        reg.setValue(0);
        reg.setXM(0_765432L);
        assertEquals(0_000000_765432L, reg.getValue());
    }
    ...
    public void testSetXM24() {
        ...
        assertEquals(0_000056_765432L, reg.getValue());
    }

    @Test
    public void testDecrementCounter18() {
        Register reg = new Register();
        reg.setValue(0_000000_000005L);
        reg.decrementCounter18();
        assertEquals(0_000004L, reg.getValue());
        
        reg.setValue(0);
        reg.decrementCounter18();
        // --0 is -1, & 0_777777 is 0_777777
        assertEquals(0_777777L, reg.getValue());
    }
    ...
    public void testDecrementCounter24() {
        ...
        assertEquals(4, reg.getValue());

        reg.setValue(0);
        reg.decrementCounter24();
        assertEquals(0_7777_7777L, reg.getValue());
    }
