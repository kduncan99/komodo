...
public class TestORFunction extends FunctionUnitTest {
    ...
    @Test
    public void testOR_A15_EM() throws MachineInterrupt, EngineHaltedException {
        var code = new long[] {
    ...
    @Test
    public void testOR_PartialWord_BM() throws MachineInterrupt, EngineHaltedException {
        var code = new long[]{
