 ...
 */
public class TestTEFunction extends FunctionUnitTest {
    ...
    public void testTE_W_EM() throws MachineInterrupt {
        ...
        loadBaseRegister((short) 0, false, 0_1000, 0_1777, AbsoluteAddress.encodeToLong(0, 0), code);
        loadBaseRegister((short) 2, false, 0_22000, 0_22777, AbsoluteAddress.encodeToLong(0, 0), data);
    ...
    public void testTE_GRS_ReferenceViolation_EM() throws MachineInterrupt {
        var code = new long[] {
            teEM(Constants.JFIELD_W, 2, 0, 0, 0, 0, 0120),
            0,
            0,
            };
    ...
    public void testTE_Q3_EM() throws MachineInterrupt {
        ...
        loadBaseRegister((short) 0, false, 0_1000, 0_1777, AbsoluteAddress.encodeToLong(0, 0), code);
        loadBaseRegister((short) 2, false, 0, 0_777, AbsoluteAddress.encodeToLong(0, 0), data);
