...
public class TestJNDFFunction extends FunctionUnitTest {
    ...
    @Test
    public void testJNDF_BM() throws MachineInterrupt {
    ...
    @Test
    public void testJNDF_BM_NoJump() throws MachineInterrupt {
        var code = new long[01000];
        code[0] = jndfBM(0_1005);
    ...
    @Test
    public void testJNDF_EM() throws MachineInterrupt {
        var code = new long[01000];
    ...
    @Test
    public void testJNDF_EM_NoJump() throws MachineInterrupt {
        var code = new long[01000];
        code[0] = jndfEM(0_1005);
    ...
    @Test
    public void testJNDF_Indexed_BM() throws MachineInterrupt {
        var code = new long[01000];
    ...
    @Test
    public void testJNDF_Indirect_BM() throws MachineInterrupt {
    ...
    @Test
    public void testJNDF_Indexed_EM() throws MachineInterrupt {
        var code = new long[01000];
