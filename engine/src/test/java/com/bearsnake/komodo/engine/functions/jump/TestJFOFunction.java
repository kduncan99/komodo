...
public class TestJFOFunction extends TestFunction {
    ...
    @Test
    public void testJFO_BM() throws MachineInterrupt, EngineHaltedException {
        setupBM();
        var bank = _engine.getBaseRegister(12).getStorage();
        bank.set(0, jfoBM(0_100));

        // Case 1: Characteristic Overflow set -> Should jump
        ...
        // Case 2: Characteristic Overflow clear -> Should NOT jump
    ...
    @Test
    public void testJFO_EM() throws MachineInterrupt, EngineHaltedException {
        setupEM();
        var bank = _engine.getBaseRegister(0).getStorage();
        bank.set(0, jfoEM(0_100));
    ...
    @Test
    public void testJFO_Indexed_BM() throws MachineInterrupt, EngineHaltedException {
        setupBM();
        _engine.getExecOrUserXRegister(3).setXM(0_10);
        var bank = _engine.getBaseRegister(12).getStorage();
        bank.set(0, jfoBM(3, 0, 0, 0_100)); // jump to 0_100 + X3.m (0_10) = 0_110
    ...
    @Test
    public void testJFO_Indirect_BM() throws MachineInterrupt, EngineHaltedException {
        setupBM();
        var bank = _engine.getBaseRegister(12).getStorage();
        bank.set(0, jfoBM(0, 0, 1, 0_100)); // jump indirect via 0_100
    ...
    @Test
    public void testJFO_Indexed_EM() throws MachineInterrupt, EngineHaltedException {
        setupEM();
        _engine.getExecOrUserXRegister(3).setXM(0_10);
        var bank = _engine.getBaseRegister(0).getStorage();
        bank.set(0, jfoEM(3, 0_100)); // jump to 0_100 + X3.m (0_10) = 0_110
