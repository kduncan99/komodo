...
public class TestDSCFunction extends FunctionUnitTest {
    ...
    @Test
    public void testDSC_Shift36_EM() throws MachineInterrupt {
        var code = new long[] {
            dscImm(4, 0, 36),
            0,
        };
    ...
    @Test
    public void testDSC_Shift72_EM() throws MachineInterrupt {
        var code = new long[] {
            dscImm(6, 0, 72),
            0,
        };
