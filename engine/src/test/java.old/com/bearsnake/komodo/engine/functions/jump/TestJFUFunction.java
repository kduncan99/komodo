...
public class TestJFUFunction extends FunctionUnitTest {

    private long jfuBM(long x, long h, long i, long u) {
        return fjaxhiu(0_74, 0_14, 0_01, x, h, i, u);
    }

    private long jfuBM(long u) {
        return jfuBM(0, 0, 0, u);
    }

    private long jfuEM(long x, long u) {
        return fjaxu(0_74, 0_14, 0_01, x, u);
    }

    private long jfuEM(long u) {
        return jfuEM(0, u);
    }
    ...
    @Test
    public void testJFU_BM() throws MachineInterrupt, EngineHaltedException {
        setupBM();
        var bank = _engine.getBaseRegister(12).getStorage();
        bank.set(0, jfuBM(0_100));

        // Case 1: Characteristic Underflow set -> Should jump
        ...
        // Case 2: Characteristic Underflow clear -> Should NOT jump
    ...
    @Test
    public void testJFU_EM() throws MachineInterrupt, EngineHaltedException {
        setupEM();
        var bank = _engine.getBaseRegister(0).getStorage();
        bank.set(0, jfuEM(0_100));
    ...
    @Test
    public void testJFU_Indexed_BM() throws MachineInterrupt, EngineHaltedException {
        setupBM();
        _engine.getExecOrUserXRegister(3).setXM(0_10);
        var bank = _engine.getBaseRegister(12).getStorage();
        bank.set(0, jfuBM(3, 0, 0, 0_100)); // jump to 0_100 + X3.m (0_10) = 0_110
    ...
    @Test
    public void testJFU_Indirect_BM() throws MachineInterrupt, EngineHaltedException {
        setupBM();
        var bank = _engine.getBaseRegister(12).getStorage();
        bank.set(0, jfuBM(0, 0, 1, 0_100)); // jump indirect via 0_100
    ...
    @Test
    public void testJFU_Indexed_EM() throws MachineInterrupt, EngineHaltedException {
        setupEM();
        _engine.getExecOrUserXRegister(3).setXM(0_10);
        var bank = _engine.getBaseRegister(0).getStorage();
        bank.set(0, jfuEM(3, 0_100)); // jump to 0_100 + X3.m (0_10) = 0_110
