...
/**
 * Test Minus Zero or Greater Than Zero instruction
 * (TMZG) skips if (U) = -0 OR (U) > +0.
 * Extended Mode only, f=050, j=0, a=05.
 */
public class TestTMZGFunction extends FunctionUnitTest {
    ...
    private long tmzgEM(long j, long x, long h, long i, long b, long d) {
        return fjaxhibd(050, j, 05, x, h, i, b, d);
    }

    @Test
    public void testTMZG_NegativeZero_EM() throws MachineInterrupt {
        var code = new long[] {
            tmzgEM(Constants.JFIELD_W, 0, 0, 0, 2, 0), // Use JFIELD_W to fetch from B2+0
            0,
            0,
        };
    ...
    @Test
    public void testTMZG_PositiveZero_NoSkip_EM() throws MachineInterrupt {
        var code = new long[] {
            tmzgEM(Constants.JFIELD_W, 0, 0, 0, 2, 0),
            0,
            0,
        };
    ...
    @Test
    public void testTMZG_PositiveNonZero_EM() throws MachineInterrupt {
        var code = new long[] {
            tmzgEM(Constants.JFIELD_W, 0, 0, 0, 2, 0),
            0,
            0,
    ...
    @Test
    public void testTMZG_NegativeNonZero_NoSkip_EM() throws MachineInterrupt {
        var code = new long[] {
            tmzgEM(Constants.JFIELD_W, 0, 0, 0, 2, 0),
            0,
            0,
