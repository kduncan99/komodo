...
public class TestJDFFunction extends FunctionUnitTest {
    ...
    @Test
    public void testJDF_BM() throws MachineInterrupt, EngineHaltedException {
        setupBM();
        var bank = _engine.getBaseRegister(12).getStorage();
        bank.set(0, jdfBM(0_100));

        // Case 1: Divide Check set -> Should jump
        ...
        // Case 2: Divide Check clear -> Should NOT jump
    ...
    @Test
    public void testJDF_EM() throws MachineInterrupt, EngineHaltedException {
        setupEM();
        var bank = _engine.getBaseRegister(0).getStorage();
        bank.set(0, jdfEM(0_100));
    ...
    @Test
    public void testJDF_Indirect_BM() throws MachineInterrupt, EngineHaltedException {
        setupBM();
        var bank = _engine.getBaseRegister(12).getStorage();
        bank.set(0, jdfBM(0, 0, 1, 0_100)); // jump indirect via 0_100
