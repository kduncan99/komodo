...
public class TestLXSIFunction extends FunctionUnitTest {

    private long lxsiImm(long j, long a, long x, long u) {
        return fjaxu(051, j, a, x, u);
    }

    private long lxsiEM(long j, long a, long x, long h, long i, long b, long d) {
        return fjaxhibd(051, j, a, x, h, i, b, d);
    }
    ...
    @Test
    public void testLXSIImmediate_EM() throws MachineInterrupt {
        var code = new long[] {
            lxsiImm(Constants.JFIELD_U, 2, 0, 0123),
            0,
        };
    ...
    @Test
    public void testLXSI_EM() throws MachineInterrupt {
        var code = new long[] {
            lxsiEM(Constants.JFIELD_W, 2, 0, 0, 0, 2, 2),
            0,
        };
    ...
    @Test
    public void testLXSI_Indexed_EM() throws MachineInterrupt {
        var code = new long[] {
            lxsiEM(Constants.JFIELD_W, 5, 3, 1, 0, 1, 01),
            0,
            };
    ...
    @Test
    public void testLXSI_Q3_EM() throws MachineInterrupt {
        var code = new long[] {
            lxsiEM(Constants.JFIELD_Q3, 15, 0, 0, 0, 1, 0),
            0,
        };
