...
public class SymbiontFileWriter implements SymbiontWriter {
    ...
    private static final Logger LOGGER = LogManager.getLogger(SymbiontFileWriter.class);
    ...
    public void writeDataImage(
        ...
        LOGGER.traceEntry("writeDataImage:'{}'", image);//TODO remove
    ...
    public void writeDataImage(
        ...
        LOGGER.traceEntry("writeDataImage:spacing={} image={}", spacing, image);// TODO remove
        ArraySlice dataBuffer;
    ...
    private void writeWord(
        ...
        LOGGER.traceEntry(String.format("writeWord:0x%012o", word));// TODO remove
    ...
    private void writeWords(
        ...
        LOGGER.traceEntry(String.format("writeWords:offset=%d count=%d", offset, count));// TODO remove
        var wx = offset;
        var remaining = count;
        while (remaining > 0) {
            writeWord(words[wx++]);
