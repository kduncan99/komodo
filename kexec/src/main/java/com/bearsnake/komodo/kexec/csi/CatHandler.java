...
class CatHandler extends CSIHandler {

    private static final Logger LOGGER = LogManager.getLogger(CatHandler.class);
    ...
    handleUnknown(
        ...
        synchronized (fm) {
            try {
                ...
                LOGGER.fatal("getFileCycleInfo() should not have failed");
