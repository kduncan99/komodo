...
public class StandardConsole implements Console {
    ...
    private static final Logger LOGGER = LogManager.getLogger(StandardConsole.class);
    ...
    public void clearReadReplyMessage(MessageId messageId) throws ConsoleException {
        LOGGER.traceEntry("clearReadReplyMessage({})", messageId);
        for (int mx = 0; mx < 10; mx++) {
            if ((_activeReadReplyMessages[mx] != null)
                ...
                LOGGER.traceExit("clearReadReplyMessage({})", messageId);
                return;
            }
        }

        LOGGER.trace("clearReadReplyMessage not found:{}", messageId);
