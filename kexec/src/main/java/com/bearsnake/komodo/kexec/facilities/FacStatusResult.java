...
public class FacStatusResult {
    ...
    public void log(
        ...
        _infos.forEach(s -> logger.log(level, "FacStatus Code={}", s.toString()));
        _warnings.forEach(s -> logger.log(level, "FacStatus Code={}", s.toString()));
        _errors.forEach(s -> logger.log(level, "FacStatus Code={}}", s.toString()));
        logger.log(level, String.format("%012o", _statusWord));
    }
