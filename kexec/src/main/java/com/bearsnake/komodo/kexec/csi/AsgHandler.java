...
class AsgHandler extends CSIHandler {

    private static final Logger LOGGER = LogManager.getLogger(AsgHandler.class);
    ...
    private void handleCatalogedFile(
        ...
        if (equip == null) {
            ...
            try {
                ...
                LOGGER.fatal("fsInfo for {}*{} references abs cycle which MFD cannot find", fsInfo.getQualifier(), fsInfo.getFilename());
