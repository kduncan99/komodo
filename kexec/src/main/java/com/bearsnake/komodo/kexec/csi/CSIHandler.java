...
abstract class CSIHandler {

    private static final Logger LOGGER = LogManager.getLogger(CSIHandler.class);
        ...
        if (!hp._statement._optionsFields.isEmpty()) {
            ...
            for (var ch : optStr.toUpperCase().toCharArray()) {
                if (!Character.isAlphabetic(ch)) {
                    LOGGER.warn("Invalid character in options field:{}", optStr);
