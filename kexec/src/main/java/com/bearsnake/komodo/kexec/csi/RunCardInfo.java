...
public class RunCardInfo {
     ...
     * @throws SyntaxErrorParserException with descriptive text
     */
     ...
     * @throws SyntaxErrorParserException with descriptive text
     */
    public RunCardInfo parse(final ParsedStatement statement) throws SyntaxErrorParserException {
        var opts = statement._optionsFields;
        var operands = statement._operandFields;

        if (opts.size() > 3) {
            throw new SyntaxErrorParserException("Invalid field or subfield in @RUN card");
        }
        ...
        if (_runid != null) {
            ...
            if (!Parser.isValidRunid(_runid)) {
                throw new SyntaxErrorParserException("Invalid RunId");
            }
        }
        ...
        if (_accountId != null) {
            ...
            if (!Parser.isValidAccountId(_accountId)) {
                throw new SyntaxErrorParserException("Invalid AccountId");
            }
        }
        ...
        if (_userId != null) {
            ...
            if (!Parser.isValidAccountId(_userId)) {
                throw new SyntaxErrorParserException("Invalid UserId");
            }
        }
        ...
        if (_projectId != null) {
            ...
            if (!Parser.isValidProjectId(_projectId)) {
                throw new SyntaxErrorParserException("Invalid ProjectId");
            }
        }
        ...
        if (source != null) {
            try {
                ...
                if ((result < 0) || (result > 0_777777)) {
                    throw new SyntaxErrorParserException("Invalid integer in @RUN statement");
                }
    ...
    private Long parseOptionWord(
        ...
        for (var ch : source.toCharArray()) {
            if (!Character.isAlphabetic(ch)) {
                throw new SyntaxErrorParserException("Invalid option in @RUN image");
            }
    ...
    private Character parsePriorityCharacter(
        ...
        if (source.length() == 1) {
            ...
            if (!Character.isAlphabetic(ch)) {
                throw new SyntaxErrorParserException("Invalid priority in @RUN image");
            }
    ...
    private Instant parseTimeSpecification(
        ...
        if (source == null) {
            ...
            if (effective.length() != 4) {
                throw new SyntaxErrorParserException("Invalid time specification in @RUN image");
            }
