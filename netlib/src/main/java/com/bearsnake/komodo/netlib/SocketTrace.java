...
public class SocketTrace {
    ...
    public static class HexSerializer extends ValueSerializer<byte[]> {
        @Override
    ...
    public static class HexDeserializer extends ValueDeserializer<byte[]> {
        @Override
    ...
    public void saveToFile(File file) throws IOException {
        ObjectMapper mapper = new ObjectMapper();
//TODO        mapper.enable(SerializationFeature.INDENT_OUTPUT);
