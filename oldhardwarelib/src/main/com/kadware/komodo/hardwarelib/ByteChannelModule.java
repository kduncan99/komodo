            ...
            synchronized (this) {
                ...
                while (iter.hasNext()) {
                    ...
                    if (!tracker._started) {
                        ...
                        iter.remove();
                        sleepFlag = false;
                    } else if (tracker._ioInfo._status != IOStatus.InProgress) {
                        //  Dev IO is done - need to possibly move some data around and set some status
                        if (tracker._ioInfo._status == IOStatus.Successful) {
                            ...
                            if (truncation) {
                                ...
                                tracker._channelProgram.setDeviceStatus(IOStatus.Successful);
                            }
                        } else {
