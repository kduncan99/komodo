...
public abstract class ChannelModule extends Node implements Worker {
    ...
    public static class ChannelProgram extends ArraySlice {
        ...
        public IOStatus getDeviceStatus() { return IOStatus.getValue((int) Word36.getS2(get(2))); }
        ...
        public void setDeviceStatus(IOStatus stat) { set(2, Word36.setS2(get(2), stat.getCode())); }
