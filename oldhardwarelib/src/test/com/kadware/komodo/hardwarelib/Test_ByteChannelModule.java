...
public class Test_ByteChannelModule {
    ...
    private static class TestTapeDevice extends Device {
        ...
        TestTapeDevice() {
            super(NodeType.Tape, NodeModel.None, "TAPE0");
            setReady(true);
        }
    ...
    public static class TestDiskDevice extends Device {
        ...
        TestDiskDevice() { super(NodeType.Disk, NodeModel.None, "DISK0"); }
    ...
    private void setup(
        ...
        if (deviceNodeType == NodeType.Disk) {
            _device = new TestDiskDevice();
        } else if (deviceNodeType == NodeType.Tape) {
