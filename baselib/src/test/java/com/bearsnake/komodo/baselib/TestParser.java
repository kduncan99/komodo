...
public class TestParser {
    ...
    @Test
    public void testDecimalInteger() throws SyntaxErrorParserException, NotFoundParserException {
        var p = new Parser("1234506789 blue");
        assertEquals(1234506789, p.parseUnsignedDecimalInteger());
    }

    @Test
    public void testDecimalIntegerNotFound() {
        Exception _ = assertThrows(NotFoundParserException.class, () -> {
    ...
    @Test
    public void testDecimalIntegerSyntax() {
        Exception _ = assertThrows(SyntaxErrorParserException.class, () -> {
    ...
    @Test
    public void testHexInteger_x() throws SyntaxErrorParserException, NotFoundParserException {
    ...
    @Test
    public void testHexIntegerNotFound() {
        Exception _ = assertThrows(NotFoundParserException.class, () -> {
    ...
    @Test
    public void testHexIntegerSyntax() {
        Exception _ = assertThrows(SyntaxErrorParserException.class, () -> {
    ...
    @Test
    public void testOctalInteger() throws SyntaxErrorParserException, NotFoundParserException {
        var p = new Parser("01234567 blue");
        assertEquals(01234567, p.parseUnsignedOctalInteger());
    }

    @Test
    public void testOctalIntegerNotFound() {
        Exception _ = assertThrows(NotFoundParserException.class, () -> {
            var p = new Parser("1234");
    ...
    @Test
    public void testOctalIntegerSyntax() {
        Exception _ = assertThrows(SyntaxErrorParserException.class, () -> {
    ...
    @Test
    public void testInteger_Decimal() throws SyntaxErrorParserException, NotFoundParserException {
        var p = new Parser("5445899034555");
        assertEquals(5445899034555L, p.parseUnsignedInteger());
    }

    @Test
    public void testInteger_Hex() throws SyntaxErrorParserException, NotFoundParserException {
        var p = new Parser("0xDEADfaceBeef");
        assertEquals(0xdeadfacebeefL, p.parseUnsignedInteger());
    }

    @Test
    public void testInteger_Octal() throws SyntaxErrorParserException, NotFoundParserException {
        var p = new Parser("000000000770077554321");
        assertEquals(0770077554321L, p.parseUnsignedInteger());
    }

    @Test
    public void testIdentifier() throws SyntaxErrorParserException, NotFoundParserException {
    ...
    @Test
    public void testIdentifierSyntaxBadChar() {
        Exception _ = assertThrows(SyntaxErrorParserException.class, () -> {
    ...
    @Test
    public void testIdentifierSyntaxTooLong() {
        Exception _ = assertThrows(SyntaxErrorParserException.class, () -> {
