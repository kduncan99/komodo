...
//    }
    ...
    //TODO this is kind of janky - do we need it?
//    /**
...
//        final BigInteger operand
//    ) {
//        long result = operand.and(BI_MANTISSA_MASK).longValue();
//        if (isNegative(operand)) {
//            result ^= MANTISSA_MASK;
//        }
//
//        return result;
//    }
...
//     * Because Components objects are invariant, we must create a new one and return it.
//     */
//    protected static Components normalizeComponents(
//        Components components
//    ) {
//        //  Initialize result to zeros, which is coincidentally the way we represent floating point 0 in components
//        if (components._integral == 0) {
//            return components._isNegative ? COMP_NEGATIVE_ZERO : COMP_POSITIVE_ZERO;
//        }
//
//        //  Downshift integral into fractional until integral is zero.
//        //  If it is already zero, then upshift the fractional until it is normalized.
//        long tempIntegral = components._integral;
//        long tempFractional = components._mantissa;
//        int resultExponent = components._exponent;
//
//        if (tempIntegral > 0) {
//            do {
//                tempFractional >>= 1;
//                if ((tempIntegral & 0x01) != 0) {
...
//        }
//
//        return new Components(components._isNegative, resultExponent, 0L, tempFractional);
//    }
}
